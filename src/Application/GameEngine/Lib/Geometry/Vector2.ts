...
import DebugVector from "@gameengine/Draw/DebugVector";
import Rotation from "@gameengine/Lib/Geometry/Rotation";
...
class Vector2 {
   ...
   */
  debug(ctx: CanvasRenderingContext2D, origin: Vector2 = new Vector2(), color?: Color, thickness?: number) {
